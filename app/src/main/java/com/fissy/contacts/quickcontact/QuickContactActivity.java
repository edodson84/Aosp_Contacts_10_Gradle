...
package com.fissy.contacts.quickcontact;
...
import com.fissy.contacts.CallUtil;
import com.fissy.contacts.ClipboardUtils;
import com.fissy.contacts.Collapser;
import com.fissy.contacts.ContactSaveService;
import com.fissy.contacts.ContactsActivity;
import com.fissy.contacts.ContactsUtils;
import com.fissy.contacts.DynamicShortcuts;
import com.fissy.contacts.NfcHandler;
import com.fissy.contacts.R;
import com.fissy.contacts.ShortcutIntentBuilder;
import com.fissy.contacts.ShortcutIntentBuilder.OnShortcutIntentCreatedListener;
import com.fissy.contacts.activities.ContactEditorActivity;
import com.fissy.contacts.activities.ContactSelectionActivity;
import com.fissy.contacts.activities.RequestPermissionsActivity;
import com.fissy.contacts.compat.CompatUtils;
import com.fissy.contacts.compat.EventCompat;
import com.fissy.contacts.compat.MultiWindowCompat;
import com.fissy.contacts.detail.ContactDisplayUtils;
import com.fissy.contacts.dialog.CallSubjectDialog;
import com.fissy.contacts.editor.ContactEditorFragment;
import com.fissy.contacts.editor.EditorIntents;
import com.fissy.contacts.editor.EditorUiUtils;
import com.fissy.contacts.interactions.ContactDeletionInteraction;
import com.fissy.contacts.interactions.TouchPointManager;
import com.fissy.contacts.lettertiles.LetterTileDrawable;
import com.fissy.contacts.list.UiIntentActions;
import com.fissy.contacts.logging.Logger;
import com.fissy.contacts.logging.QuickContactEvent.ActionType;
import com.fissy.contacts.logging.QuickContactEvent.CardType;
import com.fissy.contacts.logging.QuickContactEvent.ContactType;
import com.fissy.contacts.logging.ScreenEvent.ScreenType;
import com.fissy.contacts.model.AccountTypeManager;
import com.fissy.contacts.model.Contact;
import com.fissy.contacts.model.ContactLoader;
import com.fissy.contacts.model.RawContact;
import com.fissy.contacts.model.account.AccountType;
import com.fissy.contacts.model.dataitem.CustomDataItem;
import com.fissy.contacts.model.dataitem.DataItem;
import com.fissy.contacts.model.dataitem.DataKind;
import com.fissy.contacts.model.dataitem.EmailDataItem;
import com.fissy.contacts.model.dataitem.EventDataItem;
import com.fissy.contacts.model.dataitem.ImDataItem;
import com.fissy.contacts.model.dataitem.NicknameDataItem;
import com.fissy.contacts.model.dataitem.NoteDataItem;
import com.fissy.contacts.model.dataitem.OrganizationDataItem;
import com.fissy.contacts.model.dataitem.PhoneDataItem;
import com.fissy.contacts.model.dataitem.RelationDataItem;
import com.fissy.contacts.model.dataitem.SipAddressDataItem;
import com.fissy.contacts.model.dataitem.StructuredNameDataItem;
import com.fissy.contacts.model.dataitem.StructuredPostalDataItem;
import com.fissy.contacts.model.dataitem.WebsiteDataItem;
import com.fissy.contacts.quickcontact.ExpandingEntryCardView.Entry;
import com.fissy.contacts.quickcontact.ExpandingEntryCardView.EntryContextMenuInfo;
import com.fissy.contacts.quickcontact.ExpandingEntryCardView.EntryTag;
import com.fissy.contacts.quickcontact.ExpandingEntryCardView.ExpandingEntryCardViewListener;
import com.fissy.contacts.quickcontact.WebAddress.ParseException;
import com.fissy.contacts.util.DateUtils;
import com.fissy.contacts.util.ImageViewDrawableSetter;
import com.fissy.contacts.util.ImplicitIntentsUtil;
import com.fissy.contacts.util.MaterialColorMapUtils;
import com.fissy.contacts.util.MaterialColorMapUtils.MaterialPalette;
import com.fissy.contacts.util.PhoneCapabilityTester;
import com.fissy.contacts.util.SchedulingUtils;
import com.fissy.contacts.util.SharedPreferenceUtil;
import com.fissy.contacts.util.StructuredPostalUtils;
import com.fissy.contacts.util.UriUtils;
import com.fissy.contacts.util.ViewUtil;
import com.fissy.contacts.widget.MultiShrinkScroller;
import com.fissy.contacts.widget.MultiShrinkScroller.MultiShrinkScrollerListener;
import com.fissy.contacts.widget.QuickContactImageView;
import com.fissy.contactsbind.HelpUtils;
...
public class QuickContactActivity extends ContactsActivity {
    ...
    private static final String CALL_ORIGIN_QUICK_CONTACTS_ACTIVITY =
            "com.fissy.contacts.quickcontact.QuickContactActivity";
    ...
    private static Entry dataItemToEntry(DataItem dataItem, DataItem secondDataItem,
        ...
        if (dataItem instanceof ImDataItem) {
            ...
            if (!TextUtils.isEmpty(phone.getNumber())) {
                ...
                phoneContentDescription = com.fissy.contacts.util.ContactDisplayUtils
                ...
                smsContentDescription = com.fissy.contacts.util.ContactDisplayUtils
