...
import com.fissy.contacts.activities.AppCompatTransactionSafeActivity;
import com.fissy.contacts.testing.InjectedServices;

/**
 * A common superclass for Contacts activities that handles application-wide services, copied from
 * {@link com.fissy.contacts.ContactsActivity}, which will be deprecated after Kitkat backporting
 * is done.
 */
