...
public class ContactEditorActivity extends AppCompatContactsActivity implements
    ...
    public static final String EXTRA_ACCOUNT_WITH_DATA_SET =
            "com.fissy.contacts.ACCOUNT_WITH_DATA_SET";
